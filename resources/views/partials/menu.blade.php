<aside class="main-sidebar sidebar-dark-primary elevation-4" style="min-height: 917px;">
    ...
    <a href="#" class="brand-link">
        <span class="brand-text font-weight-light">{{ trans('blog.site_title') }}</span>
    </a>
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @can('biography_access')
                    <li class="nav-item">
                        <a href="{{ route("admin.biographies.index") }}" class="nav-link {{ request()->is("admin/biographies") || request()->is("admin/biographies/*") ? "active" : "" }}">
                            <i class="fa-fw nav-icon fas fa-book-open">

                            </i>
                            <p>
                                {{ trans('cruds.biography.title') }}
                            </p>
                        </a>
                    </li>
                @endcan
