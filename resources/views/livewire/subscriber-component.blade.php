        ...
        <div
            ...
            <form wire:submit="subscribe" class="w-full max-w-md">
                <div class="flex gap-x-4">
                    ...
                    <button type="submit"
                        class="flex-none rounded-md bg-amber-600 px-3.5 py-2.5 text-sm font-semibold text-gray-900 shadow-sm hover:bg-amber-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white">Notify
                        me</button>
